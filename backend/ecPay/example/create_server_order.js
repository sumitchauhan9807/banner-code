...
let base_param = {
  MerchantTradeNo: 'helllano2323232', //請帶20碼uid, ex: f0a0d7e9fae1bb72bc93
  ...
  PaymentToken: 'sdfsdfhjksdhfksdfkjh' // 請將Apple Server做商店驗證完回傳的Merchant Session物件中的Payment物件的JSON，轉成字串放入
}
